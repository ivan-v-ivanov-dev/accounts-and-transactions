package com.capgemini.transaction.config;
...
import static com.capgemini.transaction.config.ConfigConstants.*;

@Slf4j
@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(
        basePackages = "com.capgemini.transaction.repository",
...
public class PostgresConfig {
    ...
    public LocalContainerEntityManagerFactoryBean postgresEntityManagerFactory() {
        ...
        factory.setPackagesToScan("com.capgemini.transaction.model");
