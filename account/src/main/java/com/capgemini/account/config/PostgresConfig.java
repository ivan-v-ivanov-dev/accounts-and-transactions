package com.capgemini.account.config;
...
import static com.capgemini.account.config.ConfigConstants.*;

@Slf4j
@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(
        basePackages = "com.capgemini.account.repository",
...
public class PostgresConfig {
    ...
    public LocalContainerEntityManagerFactoryBean postgresEntityManagerFactory() {
        ...
        factory.setPackagesToScan("com.capgemini.account.model");
