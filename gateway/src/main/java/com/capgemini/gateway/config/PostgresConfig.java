...
import static com.capgemini.gateway.config.ConfigConstants.*;

@Slf4j
@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(
        basePackages = "com.capgemini.gateway.repository",
...
public class PostgresConfig {
    ...
    public LocalContainerEntityManagerFactoryBean postgresEntityManagerFactory() {
        ...
        factory.setPackagesToScan("com.capgemini.gateway.model.security");
